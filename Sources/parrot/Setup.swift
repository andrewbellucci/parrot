...
struct Setup: ParsableCommand {
    ...
    func run() throws {
        ...
        print("  1. Accessibility — to detect the push-to-talk key globally and inject text at the cursor.")
        print("  2. Microphone — to record audio while you hold the push-to-talk key.")
        print()
